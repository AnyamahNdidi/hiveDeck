...
import {videoshow} from "./Global/Global"
interface iProps {
    toggle: () => void
}
const Videoupalod:React.FC<iProps>  = ({toggle}) => {

    const [myVideo, setMyVideo] = useRecoilState(videoshow)
    const [myUtl, setMyUrl] = React.useState("")
